...
tar_gz_file_path="/home/g800336/Desktop/Source /LOGS/322270039132_2024-07-02T02_55_50_device-logs_1719910550.tar.gz"
...
def Dezip_file_tar_gz(tar_gz_file_path):
    ...
    for name in file_names:
        ...
        with open(name_with_quotes,'r') as f :
            ...
            filtrage_logs(logs, name_file[0], trace) 
...
def filtrage_logs(logs, name , choix) :
    j=0
    for entry in logs:
         if entry['trace'] == choix:
             j+=1 
    #         print("Date:", entry['month'], entry['day'])
    #         print("Heure:", entry['time'])
    #         print("Hote:", entry['host'])
    ...
    #         print("Message:", entry['message'].strip())
    #         print("-" * 50)
    message = "le nombre des logs de type  :  " + choix + "  dans le fichier  :"+ name + "  est :"
    #print (message, end=" ")
    print (message)
    print(j)
#--------------------------------------------------------------------------------------------------------------------------------------#
